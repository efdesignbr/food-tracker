...
const ANALYSIS_PROMPT = `Analise esta imagem de refeição e retorne APENAS um JSON válido com a seguinte estrutura:
...
- Se não identificar bem, retorne confidence baixo (< 0.5)
