...
type TabType = 'weight' | 'measurements';
...
export default function WeightPage() {
  ...
  function handleMeasurementSuccess() {
    fetchMeasurements();
    fetchLatestMeasurement();
  }
    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 24 }}>
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            padding: '12px 24px',
            background: activeTab === 'weight' ? '#2196F3' : 'transparent',
            color: activeTab === 'weight' ? 'white' : '#6b7280',
            border: 'none',
            borderRadius: '8px 8px 0 0',
            fontSize: 16,
            fontWeight: 600,
            cursor: 'pointer',
            borderBottom: activeTab === 'weight' ? '3px solid #2196F3' : 'none',
        ...
        <button
          ...
          style={{
            padding: '12px 24px',
            background: activeTab === 'measurements' ? '#10b981' : 'transparent',
            ...
            fontWeight: 600,
            cursor: 'pointer',
            borderBottom: activeTab === 'measurements' ? '3px solid #10b981' : 'none',
          ...
          {latestMeasurement && (
            <div style={{
              ...
              <div style={{ fontSize: 13, color: '#059669', marginTop: 8, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                ...
                {latestMeasurement.chest && <span>• Peitoral: {latestMeasurement.chest}cm</span>}
                {latestMeasurement.hips && <span>• Quadril: {latestMeasurement.hips}cm</span>}
              </div>
            </div>
          )}

          <MeasurementForm onSuccess={handleMeasurementSuccess} />
          <MeasurementTimeline measurements={measurements} onDelete={handleDeleteMeasurement} />
        </>
      )}
    </div>
  );
